...
- Markedsstandarden er rolig i det første garageår (92 → 108 midt i 2012 → 180 ved nytår) og følger den gamle kurve fra 2014, så det næste produkt i 2012 kan blive bedre end det første (spiltesten så 22 → 14 → 10/40). Guldkuponen kommer stadig først i 2015 eller senere.
- Botterne regner på løbetid: under et halvt års kasse ved ugens underskud skrues der ned for marketing, bonus og VIP. Den grådige bot brændte ellers en Serie B af på et kvartal og gik konkurs efter første bøde.
- Bonus niveau 3 giver +140 % tilgang (fra +100 %), så grådighed stadig har den højeste BSI 2012-2020, når garageåret er venligere for alle.
- Eftertanke: sim'en vælger altid tre kort (Danmark-startkortet, ét af byens tre og ét af de to offshore-kort er altid mulige). "I blev købt" kræver, at I selv solgte; kommer statsselskabets opkøb af sig selv ved tidens ende, er kortet "Statsselskabet købte jer". Virkelighedsdelen genbruger ordret fakta fra 7.15.
- Slutningen gemmes i autosave, så "Fortsæt" på titelskærmen åbner det afsluttede spil og slutskærmen.
