...
export function agentEffektLinjer(s: GameState): EffektLinje[] {
  ...
  return [
    ...
    {
      id: 'by',
      label: 'Byens beskyttelse',
      tekst: e.byBeskyttelse === 0 ? 'ingen' : `+${decimal(e.byBeskyttelse, 2)}${e.risikoOk ? ' · risikokrav opfyldt' : ''}`,
      ikon: 'hus',
      farve: 'var(--color-good)',
      aktiv: e.byBeskyttelse > 0,
      titel: 'Risikoagenter fanger tidlige tegn. Overvågning ≥ 0,6 opfylder AI-risikokrav.',
    },
