...
export const METRIC_LABELS: Record<string, { name: string; unit: Unit }> = {
  ...
  ds_share_lottery: { name: "DS andel, lotterimarkedet", unit: "pct" },
  ds_share_scratch: { name: "DS andel, skrab", unit: "pct" },
  ds_share_casino: { name: "DS andel, casino", unit: "pct" },
  ds_share_sports: { name: "DS andel, sport", unit: "pct" },
