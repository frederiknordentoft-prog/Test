...
console.log('\n=== Reduced-rate audit vs full-rate render (< 0.5 % energy lost; ⅓-oct error, 3-realisation average, within max(level allowance, 44.1/40-vs-48 kHz calibration + 1.5 dB)) ===');
