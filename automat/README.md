...
| Tests | 121 grønne: RNG-vektorer, klynger, kaskader, storm-replay, måler, golden hashes, 3,0 s-gulv, LDW-profiler, grænser mellem lag, terning-reglen, copy-lint (placardets påstand står altid i samme blok som sit forbehold), terningernes ene mutator og portens flise-gitter (1948 fliser, 974 pr. fløj, golden hashes, ingen frontlinje, ingen forudsigelig sidste flise) | `npm test` |
