...
| Basisspil (klynger + sole) | 79–81 % | 80,51 % | bestået |
...
| E2E-krydstjek | afvigelse ≤ 1,96·√(SE²+SE²) | 95,992 % ± 0,160 % (2 stikprøver, 90.829 storme) vs 96,035 %; z = -0,49 | bestået |
...
| 3 sole | 0,529 % |
| 4+ sole | 1:3.300 (eksakt; stikprøve 1:3.289) |
...
- **End-to-end-krydstjek:** en spiller med alt inline (40.000.000 spil, 30.263 storme, 18.148 rute-A-cykler som i.i.d.-batches): 95,786 % ± 0,271 % mod dekomponeringens 96,035 % (z = -1,76). Støjen er domineret af de ca. 30.263 storme (SD 286× pr. storm).
  - Supplerende e2e (`node sim/e2e.ts`, frisk frø 0x754ca5aa): 80.000.000 spil, 60.566 storme: 96,104 % ± 0,199 %.
  - Samlet (inverse-varians): 95,992 % ± 0,160 % mod 96,035 %, z = -0,49 → bestået.
